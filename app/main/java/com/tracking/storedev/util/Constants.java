...
public class Constants {
    ...
    public static String SERVICE_ON_OFF = "Service_ON_OFF";
    public static String LAST_DATE = "last_date";
    public static String DISTANCE_COVERED = "distance_covered";
    public static String IS_DISTANCE_SYNC = "isdistancesync";
}
